    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::model($domain->preference, array('route' => array('admin.domain.xpath.update', $domain->getKey()), 'method'=>'put', "onsubmit"=>"return false", "id"=>"frm-xpath-update")) !!}
                <div class="form-group">
                    {!! Form::label('xpath_1', 'xPath 1', array('class' => 'control-label')) !!}
                    {!! Form::text('xpath_1', null, array('class' => 'form-control', 'id'=>'txt-domain-url', 'placeholder'=>'Enter the primary xPath')) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('xpath_2', 'xPath 2', array('class' => 'control-label')) !!}
                    {!! Form::text('xpath_2', null, array('class' => 'form-control', 'id'=>'txt-domain-url', 'placeholder'=>'Enter the secondary xPath')) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('xpath_3', 'xPath 3', array('class' => 'control-label')) !!}
                    {!! Form::text('xpath_3', null, array('class' => 'form-control', 'id'=>'txt-domain-url', 'placeholder'=>'Enter the optional xPath')) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('xpath_4', 'xPath 4', array('class' => 'control-label')) !!}
                    {!! Form::text('xpath_4', null, array('class' => 'form-control', 'id'=>'txt-domain-url', 'placeholder'=>'Enter the optional xPath')) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('xpath_5', 'xPath 5', array('class' => 'control-label')) !!}
                    {!! Form::text('xpath_5', null, array('class' => 'form-control', 'id'=>'txt-domain-url', 'placeholder'=>'Enter the optional xPath')) !!}
                </div>
                {!! Form::close() !!}
            </div>
