...
<head><!--[if gte mso 9]>
    ...
    <title>Crawler Issue</title>
    <link rel="stylesheet" href="{{elixir('css/email.css')}}">
    <!--[if !mso]><!-- -->
    <link rel="stylesheet" href="{{elixir('css/email_import.css')}}">
    <!--<![endif]-->
    <link rel="stylesheet" href="{{elixir('css/email_brand.css')}}">
    <!--[if gte mso 12]>
    <style type="text/css">
        .custom_font {
                                                                ...
                                                                <tr class="header-container">
                                                                    <td class="header"
                                                                        ...
                                                                        <div class="header1" data-align="center"
                                                                             ...
                                                                             align="center">Crawler Issue Notification
                                                                            from SpotLite
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr class="main-container">
                                                                    <td class="main"
                                                                        ...
                                                                        <p>Over an hour since last crawl, the
                                                                            CRAWL_RESERVED_BY is still "y" which stops
                                                                            crawlers from running again.</p>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
