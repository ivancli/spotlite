                    ...
                    <div class="column" style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7217bd;" href="http://spotlite.cmail19.com/t/n/i-i-uldjjld-l-r-r-r/"><img style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;" alt="" width="560" src="http://i1.cmail19.com/ei/i/15/907/B40/131748/csfinal/SpotLiteHeaderFinal.png"></a>
                            </div>
                        </div>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;">
                            <p style="Margin-top: 0;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;"><span class="font-roboto"><strong>Hi {{isset($alert->alertable->user) ? $alert->alertable->user->first_name : ''}}&nbsp;,</strong></span></p><p style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;">
                            <span class="font-roboto">The price for the following product URLs are found to have changed.
                            </span>
...
<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="https://spotlite.cmail19.com/t/n/i-o-uldjjld-l-r/o.gif" width="1" height="1" border="0" alt="">
</body></html>