...
@section('header_title', "Import Products")
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form action="{{route('product_import.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="submitProductImport(this); return false">
                                {!! csrf_field() !!}
                                {{--TODO options here--}}

                                <div class="form-group">
                                    <label for="file" class="col-sm-3 control-label">Select Excel File</label>
                                    <div class="col-sm-9">
