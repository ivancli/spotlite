        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="line-height: 45px;">
                    ...
                    &nbsp; {!! Form::select('frequency', array("daily" => "day", "weekly" => "week", "monthly" => "month"), null, ['class'=>'form-control form-control-inline', 'onclick'=>'updateSentenceVisibility()']) !!}

                    <span class="day-sentence">
                        &nbsp;
                        ({!! Form::select('weekday_only', array("n" => "every day", "y"=>"weekday only"), null, ['class'=>'form-control form-control-inline']) !!}
                        )&nbsp; at &nbsp;
                        ...
                        ), null, ['class'=>'form-control form-control-inline']) !!}
                    </span>
                ...
                {{--<div class="form-group show-on-daily">--}}
                    ...
                    {{--{!! Form::checkbox('weekday_only', "y", is_null($category->reportTask) ? null : $category->reportTask->weekday_only == 'y', array("class" => "sl-form-control")) !!}--}}
                {{--</div>--}}
