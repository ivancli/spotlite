...
<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
            <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 167440px);">
                <div style="border-collapse: collapse;display: table;width: 100%;">
                    ...
                    <div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #e6e6e6;font-family: Roboto,Tahoma,sans-serif;">

                    </div>
                    <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
                    <div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #e6e6e6;font-family: Roboto,Tahoma,sans-serif;">
                    ...
                    <div class="column" style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7217bd;" href="http://spotlite.cmail19.com/t/n/i-i-uredll-l-r-r-r/"><img style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;" alt="" width="560" src="http://i1.cmail19.com/ei/i/B1/0BA/267/091321/csfinal/SpotLiteHeaderFinal.png"></a>
                            </div>
                        </div>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;">
                            <p style="Margin-top: 0;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;"><span class="font-roboto"><strong>Hi
                                        ...
                                        @else,
                                        @endif</strong></span></p>
                            <p style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;"><span class="font-roboto">Please find your {{$reportTask->reportable->category_name}} report attached.</span></p><p style="Margin-top: 20px;Margin-bottom: 20px;font-family: roboto,tahoma,sans-serif;"><span class="font-roboto">You can also view this information through your Reports tab:</span></p>
                        </div>
                        ...
                        <table class="column__background" style="border-collapse: collapse;table-layout: fixed;background-color: #e3e3e3;" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody><tr>
                                <td style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;'>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                            <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7217bd;" href="http://spotlite.cmail19.com/t/n/i-i-uredll-l-i-r-r/"><img style="border: 0;display: block;height: auto;width: 100%;max-width: 480px;" alt="" width="250" src="http://i3.cmail19.com/ei/i/B1/0BA/267/091321/csfinal/HELP3.png"></a>
                                        </div>
                                    </div>

                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #0f0c0f;font-size: 16px;line-height: 24px;font-family:roboto,tahoma,sans-serif;"><span class="font-roboto">Having trouble? No worries, we'll help clarify any questions!</span></h3><p class="size-18" style="Margin-top: 12px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-18"><strong><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7217bd;" href="mailto:support@spotlite.com.au">Contact Us</a></strong></p>
                                    </div>
            ...
            <div>
                <div class="layout email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="column narrow" style="text-align: left;font-size: 12px;line-height: 19px;color: #e6e6e6;font-family: Roboto,Tahoma,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <div class="layout one-col email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #e6e6e6;font-family: Roboto,Tahoma,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                <div>
...
<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="https://spotlite.cmail19.com/t/n/i-o-uredll-l-r/o.gif" width="1" height="1" border="0" alt="">
</body></html>