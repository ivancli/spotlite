                    ...
                    <div class="column" style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                <img style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;" alt="" width="560" src="http://i1.cmail19.com/ei/i/15/907/B40/101901/csfinal/SpotLiteHeaderFinal.png">
                            </div>
                        </div>
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                            <p style="Margin-top: 0;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;">
                            ...
                            <p style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;">
                                <span class="font-roboto">Please find your {{$reportTask->reportable->category_name}} report attached.</span>
                            </p>
                            <p style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;">
                                <span class="font-roboto">You can also view this information through your Reports page:</span>
                            </p>
                        </div>
                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                            <div class="btn btn--shadow btn--large" style="text-align:left;">
                                <![if !mso]><a style='border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity0.1s ease-in;color: #fff;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #7ed0c0; font-family: &#39;Open Sans&#39;, sans-serif;font-family: "Open Sans",sans-serif;' href="https://login.spotlite.com.au">VIEW MY REPORTS</a><![endif]>
                        ...
                        <table class="column__background" style="border-collapse: collapse;table-layout: fixed;background-color: #e3e3e3;" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody><tr>
                                <td style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;'>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                            <img style="border: 0;display: block;height: auto;width: 100%;max-width: 480px;" alt="" width="250" src="http://i2.cmail19.com/ei/i/15/907/B40/101901/csfinal/Alerts.png">
                                        </div>
                                    </div>
                        ...
                        <table class="column__background" style="border-collapse: collapse;table-layout: fixed;background-color: #e3e3e3;" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody><tr>
                                <td style='text-align: left;color: #464447;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;'>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;Margin-bottom: 20px;" align="center">
                                            <img style="border: 0;display: block;height: auto;width: 100%;max-width: 480px;" alt="" width="250" src="http://i3.cmail20.com/ei/i/15/907/B40/140217/csfinal/HELP31.png">
                                        </div>
                                    </div>

                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #0f0c0f;font-size: 16px;line-height: 24px;font-family:roboto,tahoma,sans-serif;"><span class="font-roboto">Having trouble? No worries, we'll help clarify any questions!</span></h3><p class="size-18" style="Margin-top: 12px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-18"><strong><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7217bd;" href="mailto:info@spotlite.com.au">Contact Us</a></strong></p>
                                    </div>
